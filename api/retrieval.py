...
# Updated retriever with better parameters for more results
retriever = vector_store.as_retriever(search_type="similarity_score_threshold", search_kwargs={"k": 2, "score_threshold": 0.3})
